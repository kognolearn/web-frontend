...
const pollAnonTopicsJob = async (jobId, anonUserId, { onProgress } = {}) => {
    ...
    while (true) {
        const { body, anonUserId: nextAnonUserId } = await fetchAnonTopicsStatus(jobId, currentAnonUserId);
        currentAnonUserId = nextAnonUserId;
...
const pollAnonCourseJob = async (jobId, anonUserId, { onProgress } = {}) => {
    ...
    let currentAnonUserId = anonUserId;
    while (true) {
        const { body, anonUserId: nextAnonUserId } = await fetchAnonCourseStatus(jobId, currentAnonUserId);
        currentAnonUserId = nextAnonUserId;
