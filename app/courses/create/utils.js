...
export const moduleConfidenceOptions = [
  {
    ...
    activeClass: "bg-[#FFE4E6] border-[#FECDD3] text-[#BE123C] dark:bg-[#4C1D25] dark:border-[#9F1239] dark:text-[#FDA4AF]",
  ...
  },
  {
    ...
    buttonClass: "border-gray-200 text-gray-600 dark:border-gray-800 dark:text-gray-400 hover:border-gray-300 dark:hover:border-gray-700",
    activeClass: "bg-[#FEF9C3] border-[#FDE68A] text-[#A16207] dark:bg-[#422006] dark:border-[#CA8A04] dark:text-[#FDE047]",
    linkLabel: null,
  },
  {
    id: "confident",
    ...
    buttonClass: "border-gray-200 text-gray-600 dark:border-gray-800 dark:text-gray-400 hover:border-gray-300 dark:hover:border-gray-700",
    activeClass: "bg-[#D1FAE5] border-[#A7F3D0] text-[#047857] dark:bg-[#064E3B] dark:border-[#059669] dark:text-[#6EE7B7]",
